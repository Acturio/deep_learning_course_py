...
La combinación de redes neuronales con gráficas

Formato de las aristas de las gráficas:
  * Para los ejes de las gráficas, se emplea el formato COO
  * La libreria provee utilidades para convertir una matriz de adyancecias a dicho
formato COO y viceversa.
...
de PyTorch con el objetivo de faciliar la implementacion
de Graph Neural Networks ("GNN")

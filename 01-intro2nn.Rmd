...
5.  Hipotesis final: Denotada como $g \approx h$ que es la función aprendida por el algoritmo
...
Tres desafíos fundamentales definen la naturaleza de los problemas en *machine learning*:
...
**Falta de información:** Se intentan identificar patrones para intentar inferior un error basado en alguna regla, pero no hay garantia de que la regla que se este intentando cumplir sea la correcta.
